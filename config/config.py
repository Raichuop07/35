...
MUSIC_BOT_NAME = str(getenv("MUSIC_BOT_NAME"))

# Your User ID.
OWNER_ID = [int(getenv("OWNER_ID_ONE")), int(getenv("OWNER_ID_TWO"))] # Input type must be interger
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/shraajestayu/ash",
)

UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")

# GIT TOKEN ( if your edited repo is private)
GIT_TOKEN = str("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")

# Only  Links formats are  accepted for this Var value.
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MusicLover_xd")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Elite_spartan")

# Set it in True if you want to leave your assistant after a certain amount of time. [Set time via AUTO_LEAVE_ASSISTANT_TIME]
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT", None)

# Time after which you're assistant account will leave chats automatically.
AUTO_LEAVE_ASSISTANT_TIME = int(getenv("AUTO_LEAVE_ASSISTANT_TIME"))  # Remember to give value in Seconds
...
GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "https://telegra.ph/file/65f99912dd82c79eeb9ad.jpg",
)
...
TELEGRAM_AUDIO_URL = getenv(
    "TELEGRAM_AUDIO_URL",
    "https://telegra.ph/file/35c355af6e25a2a10dcd4.jpg",
)

TELEGRAM_VIDEO_URL = getenv(
    "TELEGRAM_VIDEO_URL",
    "https://telegra.ph/file/20ff0d8ddad82bcaab2d8.jpg",
)
...
YOUTUBE_IMG_URL = getenv(
    "YOUTUBE_IMG_URL",
    "https://telegra.ph/file/86d722e2b32b25f1a05ed.jpg",
)

SPOTIFY_ARTIST_IMG_URL = getenv(
    "SPOTIFY_ARTIST_IMG_URL",
    "https://telegra.ph/file/ccfdb5ae7b169bef32c59.jpg",
)
